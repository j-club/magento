...
class AW_Advancednewsletter_Block_Adminhtml_Customer_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection
                ...
                ->getSelect()
                ->joinLeft(
                        array('subscriber' => Mage::getSingleton('core/resource')->getTableName('advancednewsletter/subscriber')), 'subscriber.email = e.email', array('customer_segments' => 'segments_codes'));
