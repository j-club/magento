...
class AW_Advancednewsletter_Block_Adminhtml_Form_Element_Testconnection extends Mage_Adminhtml_Block_Template
{
    ...
    protected $_states = array(
        array('value' => AW_Advancednewsletter_Model_Form_Element_Testconnection::STATUS_SUCCESS, 'label' => 'Successed', 'color' => 'green'),
        array('value' => AW_Advancednewsletter_Model_Form_Element_Testconnection::STATUS_FAIL, 'label' => 'Failed', 'color' => 'red'),
    );
