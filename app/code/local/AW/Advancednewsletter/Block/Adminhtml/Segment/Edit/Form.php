...
class AW_Advancednewsletter_Block_Adminhtml_Segment_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $params = array(
            ...
            . Mage::helper('advancednewsletter')->__("Note that this field's text  is case-sensitive <br /> and must exactly correspond to the MailChimp text")
            . '<br />' . Mage::helper('advancednewsletter')->__("This value can not be changed after saving") . '<small></p>',
        ...
        $fieldset->addField('checkout_visibility', 'select', array(
