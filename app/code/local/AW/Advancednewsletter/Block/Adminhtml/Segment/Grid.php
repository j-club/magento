...
class AW_Advancednewsletter_Block_Adminhtml_Segment_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        $this->setCollection(Mage::getModel('advancednewsletter/segment')
                ->getCollection()
                ->joinSubscribers());
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('checkout_visibility', array(
    ...
    protected function filterCount($collection, $column)
    {
        ...
        $expression = "(SELECT(COUNT(IF(FIND_IN_SET(main_table.code, segments_codes), main_table.segment_id, NULL))) from {$collection->getTable('advancednewsletter/subscriber')})";
