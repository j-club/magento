...
class AW_Advancednewsletter_Block_Adminhtml_Queue_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('subject_readonly', 'text', array(
        ...
        $fieldset->addField('sender_name_readonly', 'text', array(
        ...
        $fieldset->addField('sender_name', 'hidden', array(
            'name' => 'sender_name',           
            'value' => $queue->getTemplate()->getTemplateSenderName()
        ));

        $fieldset->addField('sender_email_readonly', 'text', array(
        ...
        $fieldset->addField('sender_email', 'hidden', array(
            'name' => 'sender_email',           
            'value' => $queue->getTemplate()->getTemplateSenderEmail()
        ));
