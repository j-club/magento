...
class Magestore_Luckydraw_Model_Refer_Gmail extends Zend_Oauth_Consumer
{
	...
	public function getGmailRequestToken(){
		return $this->getCoreSession()->getLuckydrawGmailRequestToken();
	}
	
	public function setGmailRequestToken($token){
		$this->getCoreSession()->setLuckydrawGmailRequestToken($token);
		return $this;
	}
