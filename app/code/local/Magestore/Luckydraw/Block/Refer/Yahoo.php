<?php
class Magestore_Luckydraw_Block_Refer_Yahoo extends Magestore_Luckydraw_Block_Refer_Abstract
{
	/**
	...
	public function getContacts(){
		$list = array();
		$session = Mage::getSingleton('luckydraw/refer_yahoo')->getSession();
