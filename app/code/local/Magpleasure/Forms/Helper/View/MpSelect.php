...
class Magpleasure_Forms_Helper_View_MpSelect extends Magpleasure_Forms_Helper_View_Abstract
{
    /**
     ...
     */
    public function MpSelect($name, $value = null, $attribs = null,
        $options = null, $listsep = "<br />\n")
    {
        ...
        if ($attribs['enableOther']){
            ...
            $xhtml .= "<input type=\"text\" class=\"input-text other\" title=\"{$title}\" name=\"{$name}\" id=\"\">";
        }
