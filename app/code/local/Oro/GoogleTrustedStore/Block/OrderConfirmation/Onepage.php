...
class Oro_GoogleTrustedStore_Block_OrderConfirmation_Onepage extends Mage_Core_Block_Template
{
    /**
     ...
     * @return Oro_GoogleTrustedStore_Block_OrderConfirmation_Onepage
     */
