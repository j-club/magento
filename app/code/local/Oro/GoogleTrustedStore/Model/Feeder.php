...
class Oro_GoogleTrustedStore_Model_Feeder
{
    /**
     ...
     * Saves feed to file
     *
     * @param Oro_GoogleTrustedStore_Model_Feed_Abstract $feed
     * @param string $fileName
     * @throws RuntimeException If error on file writing
     */
    protected function _saveFeedToFile(Oro_GoogleTrustedStore_Model_Feed_Abstract $feed, $fileName)
    {
