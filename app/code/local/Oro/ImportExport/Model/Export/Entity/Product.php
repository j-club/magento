<?php
/**
 * Fix bug http://www.magentocommerce.com/boards/viewthread/220342/
 * Fatal error: Unsupported operand types
 *
 * @category   Oro
 * @package    Oro_ImportExport
 * @copyright  Copyright (c) 2014 Oro Inc. DBA MageCore (http://www.magecore.com)
 */

class Oro_ImportExport_Model_Export_Entity_Product extends Mage_ImportExport_Model_Export_Entity_Product
{
    /**
     * Export process.
     *
